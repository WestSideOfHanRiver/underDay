...
class UrMaster(models.Model):
    ...
    user_idxx = models.CharField(db_column='USER_IDXX', max_length=8)
    user_pasw = models.CharField(db_column='USER_PASW', max_length=200, blank=True, null=True)
    user_abcd = models.CharField(db_column='USER_ABCD', max_length=3, blank=True, null=True)
    user_pwer = models.IntegerField(db_column='USER_PWER', blank=True, null=True)
    user_tknm = models.CharField(db_column='USER_TKNM', max_length=20, blank=True, null=True)
    user_toke = models.CharField(db_column='USER_TOKE', max_length=20, blank=True, null=True)
    user_conb = models.CharField(db_column='USER_CONB', max_length=20, blank=True, null=True)
    user_orig = models.CharField(db_column='USER_ORIG', max_length=20, blank=True, null=True)
    user_add1 = models.CharField(db_column='USER_ADD1', max_length=200, blank=True, null=True)
    user_add2 = models.CharField(db_column='USER_ADD2', max_length=200, blank=True, null=True)
    user_add3 = models.CharField(db_column='USER_ADD3', max_length=200, blank=True, null=True)
    user_imge = models.CharField(db_column='USER_IMGE', max_length=200, blank=True, null=True)
    user_pref = models.CharField(db_column='USER_PREF', max_length=200, blank=True, null=True)
    user_memo = models.CharField(db_column='USER_MEMO', max_length=200, blank=True, null=True)
